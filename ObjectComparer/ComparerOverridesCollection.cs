...
{
    public class ComparerOverridesCollection
    {
        ...
        public void AddComparer(MemberInfo memberInfo, IValueComparer valueComparer)
        {
            ...
            {
                throw new Exception($"Comparer override for member {memberInfo.MemberType} has already been added.");
            }
        ...
        public IValueComparer GetComparer(Type type)
        {
            ...
            {
                throw new Exception($"Unable to resolve comparer for type {type.GetTypeInfo().FullName}. More than one value comparer meet criteria for this type.");
            }
        ...
        public IValueComparer GetComparer(MemberInfo memberInfo)
        {
            ...
            if (_overridesByName.TryGetValue(memberInfo.Name, out var overridesByName))
            {
                ...
                {
                    throw new Exception($"Unable to resolve comparer for member {memberInfo.MemberType}. More than one value comparer meet criteria for this member.");
                }
        ...
        public IValueComparer GetComparer(string memberName)
        {
            ...
            if (overridesByName.Count > 1)
            {                
                throw new Exception($"Unable to resolve comparer for member {memberName}. More than one value comparer meet criteria for this member.");
            }
